...
namespace BookStore.Domain.Services
{
    public class BookService : IBookService
    {
        ...
        {
            if (_bookRepository.Search(c => c.Name == book.Name).Result.Any())
                return null;
        ...
        {
            if (_bookRepository.Search(c => c.Name == book.Name && c.Id != book.Id).Result.Any())
                return null;
        ...
        {
            return await _bookRepository.GetBooksByCategory(id);
        }
